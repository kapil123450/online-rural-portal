...
////////////
    ...
    final QuerySnapshot result =
        await Firestore.instance.collection('skilled_labour').where('phone', isEqualTo: "123").getDocuments();
      ...
      if (value.error == null) {
        ...
        storageTaskSnapshot.ref.getDownloadURL().then((downloadUrl) {
          ...
          Firestore.instance
              ...
              .document(id)
              .updateData({'field': field, 'Name': name, 'photoUrl': photoUrl}).then((data) async {
