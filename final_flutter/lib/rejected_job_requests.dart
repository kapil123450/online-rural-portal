...
class rejected_job_requests extends StatefulWidget {
  @override
  rejected_job_requests_state createState() =>
      new rejected_job_requests_state();
}

class rejected_job_requests_state extends State<rejected_job_requests> {
  ...
  Future getData() async {
    ...
    setState(() {
      for (var i = 0; i < docs.length; i++) {
        if (docs[i]['status'] == "0") documents.add(docs[i]);
      }
    });
